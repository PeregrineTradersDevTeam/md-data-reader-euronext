...
public class EndOfSnapshotEncoder
{
    ...
    public EndOfSnapshotEncoder lastMDSeqNum(final long value)
    {
    ...
    public EndOfSnapshotEncoder snapshotTime(final long value)
    {
    ...
    {
        EndOfSnapshotDecoder writer = new EndOfSnapshotDecoder();
