...
public class StartOfSnapshotDecoder
{
    ...
    private final StartOfSnapshotDecoder parentMessage = this;
    ...
    public StartOfSnapshotDecoder wrap(
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[StartOfSnapshot](sbeTemplateId=");
